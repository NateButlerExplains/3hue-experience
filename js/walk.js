...
import { getManifest, getGeometry, str, esc, kioskLines, stageName } from './content.js?v=2026-09-10f';
import { getState, place, rest } from './stage.js?v=2026-09-10f';
import { kioskElement, kioskCentroid, kioskVisibleAt } from './kiosk.js?v=2026-09-10f';
import { hideDoors, showDoors, setCurrent } from './hotspots.js?v=2026-09-10f';
import { lightStage, clearArcs } from './path.js?v=2026-09-10f';
import { pushLayer, resetLayers } from './focus.js?v=2026-09-10f';
import { walkButton } from './hud.js?v=2026-09-10f';
import { setLayer } from './stage.js?v=2026-09-10f';
